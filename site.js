...
const PLANIT_SITE = {
  ...
  contactEmail: 'hello@getplanit.app',
  supportEmail: 'hello@getplanit.app',
};
...
const translations = {
  es: {
    ...
    'hero-subtitle-suffix': 'sin caos en el grupo. Encuestas, gastos, chat e invitaciones en un solo sitio.',
    'hero-rotate-words': ['viajes', 'cenas', 'fiestas'],
    'hero-explore': 'Explorar funciones',
    'hero-coming': 'Próximamente en iOS y Android',
    'hero-vote': 'Encuestas en grupo',
    ...
    'mock-chat-ai': 'MIA: te propongo barbacoa el sábado',
    ...
    'stat-1': 'Todo en un solo sitio: fechas, lugares, actividades, gastos y chat del plan.',
    'stat-2-suffix': ' votos',
    ...
    'step-1-desc': 'Crea el plan y añade actividades con fechas, lugares y detalles.',
    'step-2-title': 'Invita al grupo',
    'step-2-desc': 'Comparte un código, un enlace o un QR. Propón opciones y reparte gastos.',
    'step-3-title': 'Decide y organiza',
    'step-3-desc': 'Vota en encuestas, chatea en el plan, reparte gastos y recibe recordatorios.',
    'section-features': 'Funciones',
    'features-title': 'Todo lo que necesitas para planear con amigos',
    'features-subtitle': 'Encuestas, gastos, invitaciones, chat y MIA. Sin hojas de cálculo ni hilos perdidos.',
    'f1-title': 'Planes y actividades',
    'f1-desc': 'Crea el plan y organiza actividades: fechas, lugares, notas y responsables.',
    'f2-title': 'Dividir gastos',
    'f2-desc': 'Registra gastos, saldos y quién debe a quién. Cuentas claras para todo el grupo.',
    'f3-title': 'Encuestas',
    'f3-desc': 'El grupo decide fechas y lugares votando opciones hasta cerrar la decisión.',
    ...
    'f5-desc': 'Añade actividades al plan con fechas, notas, costes estimados y responsables.',
    'f6-title': 'Participantes',
    'f6-desc': 'Todo el grupo ve el mismo plan. Roles, invitaciones y estado compartido.',
    'group-badge': 'En vivo',
    ...
    'faq-a2': 'Para organizar planes con amigos: viajes, cenas, fiestas y eventos. Incluye encuestas de fecha y lugar, actividades, gastos compartidos, invitaciones con código o QR, chat por plan, el asistente MIA y recordatorios.',
    ...
    'form-error': 'No se pudo enviar. Escríbenos a hello@getplanit.app',
  ...
  en: {
    ...
    'hero-subtitle-suffix': 'without group chat chaos. Polls, expenses, chat and invites in one place.',
    'hero-rotate-words': ['trips', 'dinners', 'parties'],
    'hero-explore': 'Explore features',
    'hero-coming': 'Coming soon on iOS & Android',
    'hero-vote': 'Group polls',
    ...
    'mock-chat-ai': 'MIA: how about a Saturday BBQ?',
    ...
    'stat-1': 'Everything in one place: dates, places, activities, expenses and plan chat.',
    'stat-2-suffix': ' votes',
    ...
    'step-1-desc': 'Create the plan and add activities with dates, places and details.',
    'step-2-title': 'Invite the group',
    'step-2-desc': 'Share a code, link or QR. Suggest options and split expenses.',
    'step-3-title': 'Decide and organize',
    'step-3-desc': 'Vote in polls, chat in the plan, split expenses and get reminders.',
    'section-features': 'Features',
    'features-title': 'Everything you need to plan with friends',
    'features-subtitle': 'Polls, expenses, invites, chat and MIA. No spreadsheets or lost threads.',
    'f1-title': 'Plans & activities',
    'f1-desc': 'Create the plan and organize activities: dates, places, notes and assignees.',
    'f2-title': 'Split costs',
    'f2-desc': 'Track expenses, balances and who owes whom. Clear shared accounts for the group.',
    'f3-title': 'Polls',
    'f3-desc': 'The group decides dates and places by voting until a decision is locked in.',
    'f4-title': 'Notifications',
    'f4-desc': 'Reminders and alerts so no one misses a deadline or update.',
    'f5-title': 'Activities',
    'f5-desc': 'Add activities to the plan with dates, notes, estimated costs and assignees.',
    'f6-title': 'Participants',
    'f6-desc': 'Everyone sees the same plan. Roles, invites and shared status.',
    'group-badge': 'Live',
    ...
    'faq-a2': 'To organize plans with friends: trips, dinners, parties and events. It includes date/place polls, activities, shared expenses, code or QR invites, plan chat, the MIA assistant and reminders.',
    ...
    'form-error': 'Could not submit. Email us at hello@getplanit.app',
  ...
  fr: {
    ...
    'hero-subtitle-suffix': 'sans le chaos du groupe. Sondages, dépenses, chat et invitations au même endroit.',
    'hero-rotate-words': ['voyages', 'dîners', 'fêtes'],
    'hero-explore': 'Découvrir les fonctions',
    'hero-coming': 'Bientôt sur iOS et Android',
    'hero-vote': 'Sondages de groupe',
    ...
    'mock-chat-ai': 'MIA : et si on faisait un barbecue samedi ?',
    ...
    'stat-1': 'Tout au même endroit : dates, lieux, activités, dépenses et chat du plan.',
    'stat-2-suffix': ' votes',
    ...
    'step-1-desc': 'Créez le plan et ajoutez des activités avec dates, lieux et détails.',
    'step-2-title': 'Invitez le groupe',
    'step-2-desc': 'Partagez un code, un lien ou un QR. Proposez des options et partagez les frais.',
    'step-3-title': 'Décidez et organisez',
    'step-3-desc': 'Votez dans les sondages, discutez dans le plan, partagez les frais et recevez des rappels.',
    'section-features': 'Fonctionnalités',
    'features-title': 'Tout pour planifier entre amis',
    'features-subtitle': 'Sondages, dépenses, invitations, chat et MIA. Sans tableurs ni fils perdus.',
    'f1-title': 'Plans et activités',
    'f1-desc': 'Créez le plan et organisez les activités : dates, lieux, notes et responsables.',
    'f2-title': 'Partage des frais',
    'f2-desc': 'Enregistrez dépenses, soldes et qui doit quoi. Comptes clairs pour tout le groupe.',
    'f3-title': 'Sondages',
    'f3-desc': 'Le groupe décide des dates et lieux en votant jusqu’à la décision finale.',
    'f4-title': 'Notifications',
    'f4-desc': 'Rappels et alertes pour que personne ne rate une échéance ou une mise à jour.',
    'f5-title': 'Activités',
    'f5-desc': 'Ajoutez des activités au plan avec dates, notes, coûts estimés et responsables.',
    'f6-title': 'Participants',
    'f6-desc': 'Tout le groupe voit le même plan. Rôles, invitations et statut partagé.',
    ...
    'faq-a2': 'Pour organiser des plans entre amis : voyages, dîners, fêtes et événements. Inclut sondages date/lieu, activités, dépenses partagées, invitations code ou QR, chat du plan, l’assistant MIA et rappels.',
    ...
    'form-error': 'Envoi impossible. Écrivez-nous à hello@getplanit.app',
  ...
  de: {
    ...
    'hero-subtitle-suffix': 'ohne Gruppenchat-Chaos. Umfragen, Ausgaben, Chat und Einladungen an einem Ort.',
    'hero-rotate-words': ['Reisen', 'Dinner', 'Partys'],
    'hero-explore': 'Funktionen entdecken',
    'hero-coming': 'Bald für iOS und Android',
    'hero-vote': 'Gruppenumfragen',
    ...
    'mock-chat-ai': 'MIA: wie wäre ein BBQ am Samstag?',
    ...
    'principle-4': 'iOS & Android',
    'stat-1': 'Alles an einem Ort: Daten, Orte, Aktivitäten, Ausgaben und Plan-Chat.',
    ...
    'step-1-desc': 'Erstelle den Plan und füge Aktivitäten mit Daten, Orten und Details hinzu.',
    'step-2-title': 'Gruppe einladen',
    'step-2-desc': 'Teile Code, Link oder QR. Schlage Optionen vor und teile Ausgaben.',
    'step-3-title': 'Entscheiden und organisieren',
    'step-3-desc': 'Stimme in Umfragen ab, chatte im Plan, teile Ausgaben und erhalte Erinnerungen.',
    'section-features': 'Funktionen',
    'features-title': 'Alles, was du zum Planen mit Freunden brauchst',
    'features-subtitle': 'Umfragen, Ausgaben, Einladungen, Chat und MIA. Keine Tabellen, keine verlorenen Threads.',
    'f1-title': 'Pläne & Aktivitäten',
    'f1-desc': 'Erstelle den Plan und organisiere Aktivitäten: Daten, Orte, Notizen und Zuständige.',
    'f2-title': 'Kosten teilen',
    'f2-desc': 'Erfasse Ausgaben, Salden und wer wem schuldet. Klare Gruppenkonten.',
    'f3-title': 'Umfragen',
    'f3-desc': 'Die Gruppe entscheidet Daten und Orte per Abstimmung bis zur finalen Entscheidung.',
    ...
    'f5-desc': 'Füge Aktivitäten mit Daten, Notizen, geschätzten Kosten und Zuständigen hinzu.',
    'f6-title': 'Teilnehmende',
    'f6-desc': 'Alle sehen denselben Plan. Rollen, Einladungen und gemeinsamer Status.',
    'group-badge': 'Live',
    ...
    'faq-a2': 'Zum Organisieren von Plänen mit Freunden: Reisen, Dinner, Partys und Events. Mit Umfragen zu Datum/Ort, Aktivitäten, gemeinsamen Ausgaben, Code- oder QR-Einladungen, Plan-Chat, dem Assistenten MIA und Erinnerungen.',
    ...
    'form-error': 'Senden fehlgeschlagen. Schreib an hello@getplanit.app',
  ...
  pt: {
    ...
    'hero-subtitle-suffix': 'sem o caos do grupo. Enquetes, despesas, chat e convites num só sítio.',
    'hero-rotate-words': ['viagens', 'jantares', 'festas'],
    'hero-explore': 'Explorar funções',
    'hero-coming': 'Em breve no iOS e Android',
    'hero-vote': 'Enquetes em grupo',
    ...
    'mock-chat-ai': 'MIA: que tal um churrasco no sábado?',
    ...
    'principle-4': 'iOS & Android',
    'stat-1': 'Tudo num só sítio: datas, locais, atividades, despesas e chat do plano.',
    'stat-2-suffix': ' votos',
    ...
    'step-1-desc': 'Cria o plano e adiciona atividades com datas, locais e detalhes.',
    'step-2-title': 'Convida o grupo',
    'step-2-desc': 'Partilha um código, link ou QR. Propõe opções e divide despesas.',
    'step-3-title': 'Decide e organiza',
    'step-3-desc': 'Vota em enquetes, conversa no plano, divide despesas e recebe lembretes.',
    'section-features': 'Funções',
    'features-title': 'Tudo o que precisas para planear com amigos',
    'features-subtitle': 'Enquetes, despesas, convites, chat e MIA. Sem folhas de cálculo nem fios perdidos.',
    'f1-title': 'Planos e atividades',
    'f1-desc': 'Cria o plano e organiza atividades: datas, locais, notas e responsáveis.',
    'f2-title': 'Dividir despesas',
    'f2-desc': 'Regista despesas, saldos e quem deve a quem. Contas claras para o grupo.',
    'f3-title': 'Enquetes',
    'f3-desc': 'O grupo decide datas e locais votando até fechar a decisão.',
    'f4-title': 'Notificações',
    'f4-desc': 'Lembretes e avisos para ninguém perder um prazo ou atualização.',
    'f5-title': 'Atividades',
    'f5-desc': 'Adiciona atividades ao plano com datas, notas, custos estimados e responsáveis.',
    'f6-title': 'Participantes',
    'f6-desc': 'Todo o grupo vê o mesmo plano. Funções, convites e estado partilhado.',
    'group-badge': 'Ao vivo',
    ...
    'faq-a2': 'Para organizar planos com amigos: viagens, jantares, festas e eventos. Inclui enquetes de data/local, atividades, despesas partilhadas, convites com código ou QR, chat do plano, a assistente MIA e lembretes.',
    ...
    'form-error': 'Não foi possível enviar. Escreve para hello@getplanit.app',
  ...
  it: {
    ...
    'hero-subtitle-prefix': 'Coordina',
    'hero-subtitle-suffix': 'senza il caos del gruppo. Sondaggi, spese, chat e inviti in un unico posto.',
    'hero-rotate-words': ['viaggi', 'cene', 'feste'],
    'hero-explore': 'Esplora le funzioni',
    'hero-coming': 'Presto su iOS e Android',
    'hero-vote': 'Sondaggi di gruppo',
    ...
    'mock-chat-ai': 'MIA: che ne dici di un barbecue sabato?',
    ...
    'principle-4': 'iOS & Android',
    'stat-1': 'Tutto in un unico posto: date, luoghi, attività, spese e chat del piano.',
    'stat-2-suffix': ' voti',
    ...
    'step-1-desc': 'Crea il piano e aggiungi attività con date, luoghi e dettagli.',
    'step-2-title': 'Invita il gruppo',
    'step-2-desc': 'Condividi un codice, un link o un QR. Proponi opzioni e dividi le spese.',
    'step-3-title': 'Decidi e organizza',
    'step-3-desc': 'Vota nei sondaggi, chatta nel piano, dividi le spese e ricevi promemoria.',
    'section-features': 'Funzioni',
    'features-title': 'Tutto ciò che ti serve per pianificare con gli amici',
    'features-subtitle': 'Sondaggi, spese, inviti, chat e MIA. Niente fogli di calcolo né thread persi.',
    'f1-title': 'Piani e attività',
    'f1-desc': 'Crea il piano e organizza le attività: date, luoghi, note e responsabili.',
    'f2-title': 'Dividere le spese',
    'f2-desc': 'Registra spese, saldi e chi deve a chi. Conti chiari per tutto il gruppo.',
    'f3-title': 'Sondaggi',
    'f3-desc': 'Il gruppo decide date e luoghi votando fino alla decisione finale.',
    'f4-title': 'Notifiche',
    'f4-desc': 'Promemoria e avvisi così nessuno perde una scadenza o un aggiornamento.',
    'f5-title': 'Attività',
    'f5-desc': 'Aggiungi attività al piano con date, note, costi stimati e responsabili.',
    'f6-title': 'Partecipanti',
    'f6-desc': 'Tutto il gruppo vede lo stesso piano. Ruoli, inviti e stato condiviso.',
    'group-badge': 'Live',
    ...
    'faq-a2': 'Per organizzare piani con gli amici: viaggi, cene, feste ed eventi. Include sondaggi data/luogo, attività, spese condivise, inviti con codice o QR, chat del piano, l’assistente MIA e promemoria.',
    ...
    'form-error': 'Invio non riuscito. Scrivici a hello@getplanit.app',
